    ...
    <>
      ...
      <section id="about" className="about">
        <div className="about-inner">
          ...
          <p className="reveal">
            After law school, I chose to pursue wine rather than practice law and moved to San Antonio to run the wine department at Gabriel&apos;s Wine &amp; Spirits. After five years, I transitioned to wholesale with Block Distributing, now Republic National Distributing Company.<br /><br />
